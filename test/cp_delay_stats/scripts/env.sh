...
export ENV_LIBRARY_PATH="/home/balaskas/ax_map_accel/circuit_generation/libs/nangate45/db"

#set the library name
export ENV_LIBRARY_DB="nangate45.db"

#set library verilog path
export ENV_LIBRARY_VERILOG_PATH="/home/balaskas/ax_map_accel/circuit_generation/libs/nangate45/verilog"

...
module top ( A, B, O );
  ...
  wire   intadd_0_CI, intadd_0_n12, intadd_0_n11, intadd_0_n10, intadd_0_n9,
         ...
         intadd_0_n3, intadd_0_n2, n25;
  assign O[0] = 1'b1;
  assign O[2] = 1'b1;
  assign O[1] = A[2];

  FA_X1 intadd_0_U13 ( .A(A[4]), .B(B[4]), .CI(intadd_0_CI), .CO(intadd_0_n12), 
        .S(O[4]) );
  ...
  FA_X1 intadd_0_U2 ( .A(B[15]), .B(A[15]), .CI(intadd_0_n2), .CO(O[16]), .S(
        O[15]) );
  AND2_X1 U18 ( .A1(B[3]), .A2(A[3]), .Z(intadd_0_CI) );
  NOR2_X1 U20 ( .A1(B[3]), .A2(A[3]), .ZN(n25) );
  NOR2_X1 U21 ( .A1(intadd_0_CI), .A2(n25), .ZN(O[3]) );
endmodule

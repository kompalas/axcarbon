...
module top ( A, B, O );
  ...
  FADDX1_RVT intadd_0_U2 ( .A(B[15]), .B(A[15]), .CI(intadd_0_n2), .CO(O[16]), 
        .S(O[15]) );
  AND2X1_RVT U16 ( .A1(B[4]), .A2(A[4]), .Y(intadd_0_CI) );
endmodule

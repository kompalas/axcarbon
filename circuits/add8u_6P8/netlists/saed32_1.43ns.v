...
module top ( A, B, O );
  ...
  FADDX1_RVT intadd_0_U6 ( .A(B[3]), .B(A[3]), .CI(intadd_0_CI), .CO(
        intadd_0_n5), .S(O[3]) );
  ...
  FADDX1_RVT intadd_0_U2 ( .A(B[7]), .B(A[7]), .CI(intadd_0_n2), .CO(O[8]), 
        .S(O[7]) );
  NAND2X0_RVT U11 ( .A1(A[2]), .A2(B[2]), .Y(n11) );
  INVX1_RVT U12 ( .A(n11), .Y(intadd_0_CI) );
  OR2X1_RVT U13 ( .A1(B[1]), .A2(A[1]), .Y(O[1]) );
  OA21X1_RVT U14 ( .A1(A[2]), .A2(B[2]), .A3(n11), .Y(O[2]) );
  OR2X1_RVT U15 ( .A1(A[0]), .A2(B[0]), .Y(O[0]) );
endmodule

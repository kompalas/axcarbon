...
module top ( A, B, O );
  ...
  SAEDRVT14_ADDF_V1_0P5 intadd_0_U2 ( .A(intadd_0_n2), .B(B[7]), .CI(A[7]), 
        .CO(O[8]), .S(O[7]) );
  SAEDRVT14_ADDF_V1_0P5 intadd_0_U7 ( .A(intadd_0_CI), .B(A[2]), .CI(B[2]), 
  ...
  SAEDRVT14_AN2_MM_0P5 U10 ( .A1(B[1]), .A2(A[1]), .X(intadd_0_CI) );
  SAEDRVT14_OR2_MM_0P5 U11 ( .A1(A[0]), .A2(B[0]), .X(O[0]) );
  SAEDRVT14_OA21B_1 U12 ( .A1(B[1]), .A2(A[1]), .B(intadd_0_CI), .X(O[1]) );
endmodule

...
module top ( inp, out );
  ...
  NAND2X1 U18 ( .A1(n16), .A2(n28), .Y(n13) );
  NAND2X1 U19 ( .A1(n37), .A2(n26), .Y(out[3]) );
  INVX1 U20 ( .A(inp[1]), .Y(n32) );
  ...
  XOR2X1 U26 ( .A1(n16), .A2(inp[3]), .Y(n30) );
  NAND2X1 U27 ( .A1(n19), .A2(n2), .Y(n16) );
  NAND2X1 U28 ( .A1(n24), .A2(n34), .Y(n19) );
  AND2X1 U29 ( .A1(n41), .A2(n38), .Y(n43) );
  INVX1 U30 ( .A(n43), .Y(n18) );
  INVX1 U31 ( .A(n35), .Y(n20) );
  NOR2X1 U32 ( .A1(n5), .A2(n24), .Y(n23) );
  INVX1 U33 ( .A(inp[0]), .Y(n24) );
  AND2X1 U34 ( .A1(n35), .A2(n39), .Y(n36) );
  INVX1 U35 ( .A(n36), .Y(n26) );
  AND2X1 U36 ( .A1(n7), .A2(n10), .Y(n45) );
  INVX1 U37 ( .A(n45), .Y(n27) );
  AND2X1 U38 ( .A1(n24), .A2(n32), .Y(n33) );
  INVX1 U39 ( .A(n33), .Y(n28) );
  AND2X1 U40 ( .A1(n40), .A2(n5), .Y(n42) );
  INVX1 U41 ( .A(n42), .Y(n29) );
  XOR2X1 U42 ( .A1(n30), .A2(n8), .Y(out[5]) );
  NAND2X1 U43 ( .A1(inp[0]), .A2(inp[1]), .Y(n31) );
  AND2X1 U44 ( .A1(n28), .A2(n31), .Y(out[1]) );
  NAND2X1 U45 ( .A1(n13), .A2(n15), .Y(out[2]) );

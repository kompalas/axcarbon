...
module top ( A, B, O );
  ...
  FA_X1 intadd_5_U6 ( .A(intadd_5_A_0_), .B(intadd_5_B_0_), .CI(
        intadd_0_SUM_0_), .CO(intadd_5_n5), .S(O[3]) );
  FA_X1 intadd_5_U5 ( .A(intadd_0_SUM_1_), .B(intadd_5_B_1_), .CI(intadd_5_n5), 
        .CO(intadd_5_n4), .S(O[4]) );
  FA_X1 intadd_5_U4 ( .A(intadd_0_SUM_2_), .B(intadd_5_B_2_), .CI(intadd_5_n4), 
        .CO(intadd_5_n3), .S(O[5]) );
  FA_X1 intadd_5_U3 ( .A(intadd_0_SUM_3_), .B(intadd_5_B_3_), .CI(intadd_5_n3), 
        .CO(intadd_5_n2), .S(O[6]) );
  FA_X1 intadd_5_U2 ( .A(intadd_0_SUM_4_), .B(intadd_5_B_4_), .CI(intadd_5_n2), 
  ...
  INV_X1 U159 ( .A(B[0]), .ZN(n216) );
  INV_X1 U160 ( .A(A[0]), .ZN(n224) );
  INV_X1 U161 ( .A(B[2]), .ZN(n223) );
  INV_X1 U162 ( .A(A[1]), .ZN(n222) );
  INV_X1 U163 ( .A(B[1]), .ZN(n221) );
  NOR4_X1 U164 ( .A1(n224), .A2(n223), .A3(n222), .A4(n221), .ZN(intadd_0_B_0_) );
  AND2_X1 U165 ( .A1(intadd_5_n1), .A2(intadd_0_SUM_5_), .ZN(intadd_0_B_6_) );
  NOR2_X1 U166 ( .A1(n224), .A2(n216), .ZN(O[0]) );
  NOR2_X1 U167 ( .A1(n222), .A2(n216), .ZN(n210) );
  INV_X1 U168 ( .A(n210), .ZN(n192) );
  OAI21_X1 U169 ( .B1(n221), .B2(n224), .A(n192), .ZN(O[1]) );
  INV_X1 U170 ( .A(B[6]), .ZN(n193) );
  INV_X1 U171 ( .A(A[3]), .ZN(n212) );
  NOR2_X1 U172 ( .A1(n193), .A2(n212), .ZN(intadd_6_A_0_) );
  INV_X1 U173 ( .A(A[2]), .ZN(n207) );
  INV_X1 U174 ( .A(B[7]), .ZN(n194) );
  NOR2_X1 U175 ( .A1(n207), .A2(n194), .ZN(intadd_6_B_0_) );
  NAND2_X1 U176 ( .A1(A[1]), .A2(B[6]), .ZN(n195) );
  AOI211_X1 U177 ( .C1(n224), .C2(n207), .A(n194), .B(n195), .ZN(intadd_6_CI)
         );
  INV_X1 U178 ( .A(A[4]), .ZN(n213) );
  NOR2_X1 U179 ( .A1(n193), .A2(n213), .ZN(intadd_6_A_1_) );
  NOR2_X1 U180 ( .A1(n194), .A2(n212), .ZN(intadd_6_B_1_) );
  INV_X1 U181 ( .A(A[5]), .ZN(n214) );
  NOR2_X1 U182 ( .A1(n193), .A2(n214), .ZN(intadd_6_A_2_) );
  NOR2_X1 U183 ( .A1(n194), .A2(n213), .ZN(intadd_6_B_2_) );
  INV_X1 U184 ( .A(A[6]), .ZN(n215) );
  NOR2_X1 U185 ( .A1(n193), .A2(n215), .ZN(intadd_6_A_3_) );
  NOR2_X1 U186 ( .A1(n194), .A2(n214), .ZN(intadd_6_B_3_) );
  INV_X1 U187 ( .A(A[7]), .ZN(n219) );
  NOR2_X1 U188 ( .A1(n219), .A2(n193), .ZN(intadd_6_A_4_) );
  NOR2_X1 U189 ( .A1(n194), .A2(n215), .ZN(intadd_6_B_4_) );
  NOR2_X1 U190 ( .A1(n224), .A2(n194), .ZN(n196) );
  XNOR2_X1 U191 ( .A(n196), .B(n195), .ZN(intadd_1_A_0_) );
  NAND2_X1 U192 ( .A1(A[0]), .A2(B[6]), .ZN(n201) );
  NAND2_X1 U193 ( .A1(A[1]), .A2(B[5]), .ZN(n200) );
  NOR2_X1 U194 ( .A1(n201), .A2(n200), .ZN(intadd_1_B_0_) );
  INV_X1 U195 ( .A(B[5]), .ZN(n199) );
  NOR2_X1 U196 ( .A1(n207), .A2(n199), .ZN(intadd_1_CI) );
  NOR2_X1 U197 ( .A1(n199), .A2(n212), .ZN(intadd_1_A_1_) );
  NAND3_X1 U198 ( .A1(B[7]), .A2(A[1]), .A3(n201), .ZN(n198) );
  NAND2_X1 U199 ( .A1(B[6]), .A2(A[2]), .ZN(n197) );
  XOR2_X1 U200 ( .A(n198), .B(n197), .Z(intadd_1_B_1_) );
  NOR2_X1 U201 ( .A1(n199), .A2(n213), .ZN(intadd_1_A_2_) );
  NOR2_X1 U202 ( .A1(n199), .A2(n214), .ZN(intadd_1_A_3_) );
  NOR2_X1 U203 ( .A1(n199), .A2(n215), .ZN(intadd_1_B_4_) );
  NOR2_X1 U204 ( .A1(n219), .A2(n199), .ZN(intadd_1_B_5_) );
  INV_X1 U205 ( .A(B[4]), .ZN(n202) );
  NOR2_X1 U206 ( .A1(n219), .A2(n202), .ZN(intadd_2_B_5_) );
  NOR2_X1 U207 ( .A1(n207), .A2(n202), .ZN(intadd_2_A_0_) );
  NAND2_X1 U208 ( .A1(A[0]), .A2(B[4]), .ZN(n206) );
  NOR2_X1 U209 ( .A1(n206), .A2(n200), .ZN(intadd_2_B_0_) );
  AOI21_X1 U210 ( .B1(n201), .B2(n200), .A(intadd_1_B_0_), .ZN(intadd_2_CI) );
  NOR2_X1 U211 ( .A1(n202), .A2(n212), .ZN(intadd_2_B_1_) );
  NOR2_X1 U212 ( .A1(n202), .A2(n213), .ZN(intadd_2_B_2_) );
  NOR2_X1 U213 ( .A1(n202), .A2(n214), .ZN(intadd_2_B_3_) );
  NOR2_X1 U214 ( .A1(n202), .A2(n215), .ZN(intadd_2_B_4_) );
  INV_X1 U215 ( .A(B[3]), .ZN(n204) );
  NOR2_X1 U216 ( .A1(n207), .A2(n204), .ZN(intadd_3_A_0_) );
  NOR3_X1 U217 ( .A1(n222), .A2(n204), .A3(n206), .ZN(intadd_3_B_0_) );
  AOI22_X1 U218 ( .A1(A[0]), .A2(B[5]), .B1(A[1]), .B2(B[4]), .ZN(n203) );
  NOR2_X1 U219 ( .A1(intadd_2_B_0_), .A2(n203), .ZN(intadd_3_CI) );
  NOR2_X1 U220 ( .A1(n204), .A2(n212), .ZN(intadd_3_A_1_) );
  NOR2_X1 U221 ( .A1(n204), .A2(n213), .ZN(intadd_3_B_2_) );
  NOR2_X1 U222 ( .A1(n204), .A2(n214), .ZN(intadd_3_B_3_) );
  NOR2_X1 U223 ( .A1(n204), .A2(n215), .ZN(intadd_3_B_4_) );
  NOR2_X1 U224 ( .A1(n219), .A2(n204), .ZN(intadd_3_B_5_) );
  NOR2_X1 U225 ( .A1(n223), .A2(n207), .ZN(intadd_4_A_0_) );
  NOR4_X1 U226 ( .A1(n224), .A2(n223), .A3(n222), .A4(n204), .ZN(intadd_4_B_0_) );
  NAND2_X1 U227 ( .A1(A[1]), .A2(B[3]), .ZN(n205) );
  AOI21_X1 U228 ( .B1(n206), .B2(n205), .A(intadd_3_B_0_), .ZN(intadd_4_CI) );
  NOR2_X1 U229 ( .A1(n223), .A2(n212), .ZN(intadd_4_A_1_) );
  NOR2_X1 U230 ( .A1(n223), .A2(n213), .ZN(intadd_4_B_2_) );
  NOR2_X1 U231 ( .A1(n223), .A2(n214), .ZN(intadd_4_B_3_) );
  NOR2_X1 U232 ( .A1(n223), .A2(n215), .ZN(intadd_4_B_4_) );
  NOR2_X1 U233 ( .A1(n223), .A2(n219), .ZN(intadd_4_B_5_) );
  NOR2_X1 U234 ( .A1(n221), .A2(n207), .ZN(intadd_0_A_0_) );
  NAND2_X1 U235 ( .A1(A[0]), .A2(B[3]), .ZN(n209) );
  NAND2_X1 U236 ( .A1(B[2]), .A2(A[1]), .ZN(n208) );
  AOI21_X1 U237 ( .B1(n209), .B2(n208), .A(intadd_4_B_0_), .ZN(intadd_0_CI) );
  NOR2_X1 U238 ( .A1(n221), .A2(n212), .ZN(intadd_0_A_1_) );
  NOR2_X1 U239 ( .A1(n221), .A2(n213), .ZN(intadd_0_B_2_) );
  NOR2_X1 U240 ( .A1(n221), .A2(n214), .ZN(intadd_0_B_3_) );
  NOR2_X1 U241 ( .A1(n221), .A2(n215), .ZN(intadd_0_B_4_) );
  NOR2_X1 U242 ( .A1(n221), .A2(n219), .ZN(intadd_0_B_5_) );
  AOI22_X1 U243 ( .A1(n210), .A2(intadd_0_A_0_), .B1(O[0]), .B2(intadd_4_A_0_), 
        .ZN(n211) );
  NOR2_X1 U244 ( .A1(intadd_0_B_0_), .A2(n211), .ZN(intadd_5_A_0_) );
  NOR2_X1 U245 ( .A1(n216), .A2(n212), .ZN(intadd_5_B_0_) );
  NOR2_X1 U246 ( .A1(n216), .A2(n213), .ZN(intadd_5_B_1_) );
  NOR2_X1 U247 ( .A1(n216), .A2(n214), .ZN(intadd_5_B_2_) );
  NOR2_X1 U248 ( .A1(n216), .A2(n215), .ZN(intadd_5_B_3_) );
  NOR2_X1 U249 ( .A1(n216), .A2(n219), .ZN(intadd_5_B_4_) );
  INV_X1 U250 ( .A(intadd_6_n1), .ZN(n220) );
  NAND2_X1 U251 ( .A1(B[7]), .A2(A[7]), .ZN(n217) );
  XOR2_X1 U252 ( .A(n220), .B(n217), .Z(n228) );
  NAND2_X1 U253 ( .A1(intadd_0_n1), .A2(n228), .ZN(n218) );
  OAI21_X1 U254 ( .B1(n220), .B2(n219), .A(n218), .ZN(O[15]) );
  INV_X1 U255 ( .A(intadd_0_B_0_), .ZN(n226) );
  OAI22_X1 U256 ( .A1(n224), .A2(n223), .B1(n222), .B2(n221), .ZN(n225) );
  AOI22_X1 U257 ( .A1(A[2]), .A2(B[0]), .B1(n226), .B2(n225), .ZN(n227) );
  NOR2_X1 U258 ( .A1(intadd_5_A_0_), .A2(n227), .ZN(O[2]) );
  XOR2_X1 U259 ( .A(intadd_0_n1), .B(n228), .Z(O[14]) );
  XOR2_X1 U260 ( .A(intadd_5_n1), .B(intadd_0_SUM_5_), .Z(O[8]) );
endmodule

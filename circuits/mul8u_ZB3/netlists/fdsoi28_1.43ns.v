...
module top ( A, B, O );
  ...
  INV_X1 U159 ( .A(A[0]), .ZN(n224) );
  INV_X1 U160 ( .A(B[2]), .ZN(n223) );
  INV_X1 U161 ( .A(A[1]), .ZN(n222) );
  INV_X1 U162 ( .A(B[1]), .ZN(n221) );
  NOR4_X1 U163 ( .A1(n224), .A2(n223), .A3(n222), .A4(n221), .ZN(intadd_0_B_0_) );
  AND2_X1 U164 ( .A1(intadd_5_n1), .A2(intadd_0_SUM_5_), .ZN(intadd_0_B_6_) );
  INV_X1 U165 ( .A(B[0]), .ZN(n216) );
  ...
  XOR2_X1 U252 ( .A(n217), .B(n220), .Z(n228) );

...
void AOI21_X1 ( int A1, int A2, int B, int* ZN){
 int i_9 = A1 & A2;
 int i_8 = B | i_9;
 *ZN = 1 ^ i_8;
}

void AOI21_X2 ( int A1, int A2, int B, int* ZN){
 int i_9 = A1 & A2;
 int i_8 = B | i_9;
 *ZN = 1 ^ i_8;
}
...
void OAI21_X1 ( int A1, int A2, int B, int* ZN){
 int i_9 = A1 | A2;
 int i_8 = B & i_9;
 *ZN = 1 ^ i_8;
}

void OAI21_X2 ( int A1, int A2, int B, int* ZN){
 int i_9 = A1 | A2;
 int i_8 = B & i_9;
 *ZN = 1 ^ i_8;
}
